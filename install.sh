...
WALLET_TAR_ARM_64=$(curl -s https://api.github.com/repos/The-Yerbas-Endeavor/yerbas/releases/latest | jq -r '.assets[] | select(.name|test("ubuntu-26.04.arm64-release.")) | .browser_download_url')
WALLET_TAR_U_22=$(curl -s https://api.github.com/repos/The-Yerbas-Endeavor/yerbas/releases/latest | jq -r '.assets[] | select(.name|test("ubuntu-22.04-x86-release.")) | .browser_download_url')
WALLET_TAR_U_24=$(curl -s https://api.github.com/repos/The-Yerbas-Endeavor/yerbas/releases/latest | jq -r '.assets[] | select(.name|test("ubuntu-24.04-x86-release.")) | .browser_download_url')
WALLET_TAR_U_26=$(curl -s https://api.github.com/repos/The-Yerbas-Endeavor/yerbas/releases/latest | jq -r '.assets[] | select(.name|test("ubuntu-26.04-x86-release.")) | .browser_download_url')
