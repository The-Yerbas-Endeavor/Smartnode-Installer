...
WALLET_TAR_U_22=$(curl -s https://api.github.com/repos/The-Yerbas-Endeavor/yerbas/releases/latest | jq -r '.assets[] | select(.name|test("ubuntu22-x86-release.")) | .browser_download_url')
WALLET_TAR_U_24=$(curl -s https://api.github.com/repos/The-Yerbas-Endeavor/yerbas/releases/latest | jq -r '.assets[] | select(.name|test("ubuntu24-x86-release.")) | .browser_download_url')
WALLET_TAR_U_26=$(curl -s https://api.github.com/repos/The-Yerbas-Endeavor/yerbas/releases/latest | jq -r '.assets[] | select(.name|test("ubuntu26-x86-release.")) | .browser_download_url')
